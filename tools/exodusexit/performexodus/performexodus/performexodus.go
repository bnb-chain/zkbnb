...
func (m *PerformExodus) PerformDesert(nftRoot [32]byte,
	exitData zkbnb.ExodusVerifierExitData, assetMerkleProof [15][32]byte, accountMerkleProof [31][32]byte) error {
...
func (m *PerformExodus) PerformDesertNft(ownerAccountIndex *big.Int, accountRoot [32]byte, exitNfts []zkbnb.ExodusVerifierExitNftData, nftMerkleProofs [][39][32]byte) error {
	gasPrice, err := m.cli.SuggestGasPrice(context.Background())
	if err != nil {
		logx.Errorf("failed to fetch gas price: %v", err)
		return err

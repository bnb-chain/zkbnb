...
type (
	LiquidityPairModel interface {
		...
		GetLiquidityPairByIndex(pairIndex uint32) (tradingPair *LiquidityPair, err error)
...
*/
func (m *defaultLiquidityPairModel) GetLiquidityPairByIndex(pairIndex uint32) (tradingPair *LiquidityPair, err error) {

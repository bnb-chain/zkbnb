...
func (w *WitnessHelper) constructDepositTxWitness(cryptoTx *TxWitness, oTx *tx.Tx) (*TxWitness, error) {
...
func toCryptoDepositTx(txInfo *legendTxTypes.DepositTxInfo) (info *std.DepositTx, err error) {
	info = &std.DepositTx{

...
func ConstructCancelOfferCryptoTx(
	oTx *Tx,
	...
	if oTx.TxType != commonTx.TxTypeCancelOffer {
		...
		return nil, errors.New("[ConstructCancelOfferCryptoTx] invalid tx type")
	}
	if oTx == nil || accountTree == nil || accountAssetsTree == nil || liquidityTree == nil || nftTree == nil {
		logx.Errorf("[ConstructCancelOfferCryptoTx] invalid params")
		return nil, errors.New("[ConstructCancelOfferCryptoTx] invalid params")
	}
	...
	if err != nil {
		logx.Errorf("[ConstructCancelOfferCryptoTx] unable to construct prover info: %s", err.Error())
		return nil, err
	}

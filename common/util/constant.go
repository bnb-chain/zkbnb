...
const (
	...
	RegisterZnsPubdataSize    = TXTYPE_BYTES_SIZE + ACCOUNTNAME_BYTES_SIZE + ACCOUNTNAMEHASH_BYTES_SIZE + PUBKEY_BYTES_SIZE
	CreatePairPubdataSize     = TXTYPE_BYTES_SIZE + PAIRINDEX_BYTES_SIZE + ASSETID_BYTES_SIZE + ASSETID_BYTES_SIZE + FEERATE_BYTES_SIZE + ACCOUNTINDEX_BYTES_SIZE + FEERATE_BYTES_SIZE
	UpdatePairRatePubdataSize = TXTYPE_BYTES_SIZE + PAIRINDEX_BYTES_SIZE + FEERATE_BYTES_SIZE + ACCOUNTINDEX_BYTES_SIZE + FEERATE_BYTES_SIZE
	...
	DepositNftPubdataSize     = TXTYPE_BYTES_SIZE + ACCOUNTINDEX_BYTES_SIZE + ACCOUNTNAMEHASH_BYTES_SIZE + ADDRESS_BYTES_SIZE + NFTTOKENID_BYTES_SIZE + FEERATE_BYTES_SIZE

...
func GetGasFeeAssets(s *AppSuite) (int, *types.RespGetGasFeeAssets) {
	resp, err := http.Get(fmt.Sprintf("%s/api/v1/info/getGasFeeAssets", s.url))
	...
	result := types.RespGetGasFeeAssets{}

...
func (c *globalRPCClient) GetNextNonce(ctx context.Context, in *ReqGetNextNonce, opts ...grpc.CallOption) (*RespGetNextNonce, error) {
	out := new(RespGetNextNonce)
	err := c.cc.Invoke(ctx, "/globalRPCProto.globalRPC/getNextNonce", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GlobalRPCServer interface {
	...
	GetNextNonce(context.Context, *ReqGetNextNonce) (*RespGetNextNonce, error)
	// NFT
...
func (UnimplementedGlobalRPCServer) GetNextNonce(context.Context, *ReqGetNextNonce) (*RespGetNextNonce, error) {
...
func _GlobalRPC_GetNextNonce_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReqGetNextNonce)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GlobalRPCServer).GetNextNonce(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/globalRPCProto.globalRPC/getNextNonce",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GlobalRPCServer).GetNextNonce(ctx, req.(*ReqGetNextNonce))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GlobalRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _GlobalRPC_GetNextNonce_Handler,
		},
		{

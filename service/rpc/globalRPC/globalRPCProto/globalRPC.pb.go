...
type AssetResult struct {
	...
	BalanceEnc string `protobuf:"bytes,2,opt,name=BalanceEnc,proto3" json:"BalanceEnc,omitempty"`
}
...
var file_globalRPC_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x42, 0x10, 0x5a, 0x0e, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x52, 0x50, 0x43, 0x50,
...
// UnimplementedGlobalRPCServer can be embedded to have forward compatible implementations.
...
func RegisterGlobalRPCServer(s *grpc.Server, srv GlobalRPCServer) {
	s.RegisterService(&_GlobalRPC_serviceDesc, srv)
}
...
var _GlobalRPC_serviceDesc = grpc.ServiceDesc{

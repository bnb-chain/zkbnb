...
var (
	...
	DbErrFailToDeleteBlock            = errors.New("fail to delete block")
	DbErrFailToDeleteCompressedBlock  = errors.New("fail to delete compressed block")
	...
	DbErrFailToDeleteTx               = errors.New("fail to delete tx")
	DbErrFailToDeleteTxDetail         = errors.New("fail to delete tx detail")
	...
	DbErrFailToDeleteAccountHistory   = errors.New("fail to delete account history")
	...
	DbErrFailToUpdateMempoolTx        = errors.New("fail to update mempool tx")
	DbErrFailToDeleteMempoolTx        = errors.New("fail to delete mempool tx")
